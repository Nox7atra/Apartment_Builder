...
namespace Foxsys.ApartmentBuilder
{
    ...
    {
        private readonly ApartmentBuilderWindow _ParentWindow;
        private readonly Skin _CurrentSkin;
        public void Draw()
        {
            if (_ParentWindow.CurrentState == ApartmentBuilderWindow.EditorWindowState.Normal)
            {
        ...
        public Toolbar(ApartmentBuilderWindow parentWindow)
        {
