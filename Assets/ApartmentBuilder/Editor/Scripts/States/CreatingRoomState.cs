...
namespace Foxsys.ApartmentBuilder
{
    public class CreatingRoomState : StateApartmentBuilder
    {
        ...
        #region constructor
        public CreatingRoomState(ApartmentBuilderWindow parentWindow) : base(parentWindow)
        {
        }
        #endregion
        ...
        public override void Reset()
        {
            ...
            _ParentWindow.ActivateState(ApartmentBuilderWindow.EditorWindowState.Normal);
        }
    }
}